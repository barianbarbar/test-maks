<?php
	...
	try {
	    ...
	    if($source_img == ''){
        	...
        	echo json_encode(array("status"=>"sukses","url"=>"https://apps.murapay.id/app/image/slider/".$filename,"thumb"=>"https://apps.murapay.id/app/image/slider/thumbnails/".$filename));
	    }
