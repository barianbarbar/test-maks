<?php
	...
	try {
	    ...
	    if($source_img == ''){
        	...
        	echo json_encode(array("status"=>"sukses","url"=>"https://murapay.id/app/image/partnership/".$filename,"thumb"=>"https://murapay.id/app/image/partnership/thumbnails/".$filename));
	    }
